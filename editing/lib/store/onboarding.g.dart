...
mixin _$OnboardingStore on OnboardingBase, Store {
  Computed<ProtectedValue>? _$passwordComputed;

  @override
  ProtectedValue get password =>
      (_$passwordComputed ??= Computed<ProtectedValue>(() => super.password,
              name: 'OnboardingBase.password'))
          .value;
